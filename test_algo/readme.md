These files can be used for testing purposes; a DEM extract is provided (France, EPSG : 2154), a friction surface (using W. Tobler's hiking formula) and two sets of points. 
